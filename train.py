...
VGG_Weights_path = "/valohai/inputs/pretrained_weights/pretrained_weights/vgg16_weights_tf_dim_ordering_tf_kernels.h5"
...
mc = ModelCheckpoint(mode='max', filepath='/valohai/outputs/model_checkpoint.h5', monitor='val_acc', save_best_only='True', save_weights_only='False', verbose=1)
...
model.save("/valohai/outputs/my_model.h5", overwrite=True)
model_json = model.to_json()
with open('/valohai/outputs/keras_model.json', "w") as json_file:
